...
object Versions {
    ...
    const val buildToolsVersion = "28.0.1"
...
object Dependencies {
    ...
    const val support_v4 = "com.android.support:support-v4:${Versions.supportLib}"
    ...
    const val room_runtime = "android.arch.persistence.room:runtime:${Versions.roomVersion}"
    const val room_compiler = "android.arch.persistence.room:compiler:${Versions.roomVersion}"
    const val room_rxjava = "android.arch.persistence.room:rxjava2:${Versions.roomVersion}"
